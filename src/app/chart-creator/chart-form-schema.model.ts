...
export class FormSchema {
  ...
  private _dataseriesFormSchema = {
        ...
        'items': {
          ...
          'properties': {
            'name': {
              ...
              'title': 'Select a prebuild query',
              'widget': {'id': 'csui-select-query-name'},
            }
          }
        }
      }
    ...
    'fieldsets': [
      {
        'tabTitle': 'Build your query',
        // 'description' : '',
        'fields': ['buildQuery']
      },
      {
        'tabTitle': 'Select a prebuild query',
        // 'description' : '',
        'fields': ['prebuildQueryName']
      }
    ]
  };
  ...
  get formSchema() {
    return this._SCGAFormSchema;
  }

  get viewFormSchema() {
    return this._viewFormSchema;
  }

  get categoriesFormSchema() {
    return this._categoryFormSchema;
  }

  get dataseriesFormSchema() {
    return this._dataseriesFormSchema;
  }

  get appearanceFormSchema() {
    return this._appearanceFormSchema;
  }
